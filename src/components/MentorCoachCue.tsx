...
const COPY: Record<Variant, { titleEn: string; titleMy: string; descEn: string; descMy: string; ctaEn: string; ctaMy: string; icon: typeof GraduationCap }> = {
  ...
  applied: {
    titleEn: "Boost your odds — talk to a mentor",
    titleMy: "အောင်မြင်နိုင်ခြေ မြှင့်တင်ရန် — လမ်းညွှန်နှင့် ဆွေးနွေးပါ",
    descEn: "A 30-minute coaching call before the interview can double your chances of being hired.",
    descMy: "အင်တာဗျူး မတိုင်မီ ၃၀ မိနစ် လမ်းညွှန်ခေါ်ဆိုမှုသည် သင့် ငှားရမ်းခံရနိုင်ခြေကို နှစ်ဆ မြှင့်ပေးနိုင်သည်။",
