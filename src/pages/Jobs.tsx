...
const jobs = [
  { title: "Senior React Developer", company: "TechCorp Asia", location: "Remote", type: "Full-time", salary: "$3,000 - $5,000/mo", postedAgo: "2 နာရီ", saved: false, tags: ["React", "TypeScript", "Node.js"] },
  { title: "UI/UX Designer", company: "DesignStudio BKK", location: "Bangkok, TH", type: "Full-time", salary: "$2,000 - $3,500/mo", postedAgo: "5 နာရီ", saved: true, tags: ["Figma", "UI Design", "Prototyping"] },
  { title: "Project Coordinator", company: "NGO Partners", location: "Remote", type: "Contract", salary: "$1,800 - $2,800/mo", postedAgo: "1 ရက်", saved: false, tags: ["Project Mgmt", "English", "Reporting"] },
  { title: "Full Stack Developer", company: "StartupHub SG", location: "Singapore", type: "Full-time", salary: "$4,000 - $6,000/mo", postedAgo: "1 ရက်", saved: false, tags: ["Python", "React", "AWS"] },
  { title: "Digital Marketing Manager", company: "Growth Co", location: "Remote", type: "Part-time", salary: "$1,500 - $2,500/mo", postedAgo: "2 ရက်", saved: true, tags: ["SEO", "Social Media", "Analytics"] },
];
      ...
      <div className="px-6 pt-6">
        ...
        <div className="mb-4 flex gap-2">
          <div className="flex flex-1 items-center gap-2 rounded-xl border border-border bg-card px-3.5 py-3">
            ...
            <input placeholder="အလုပ်ခေါင်းစဉ်၊ ကုမ္ပဏီ..." className="flex-1 bg-transparent text-sm outline-none placeholder:text-muted-foreground" />
          </div>
