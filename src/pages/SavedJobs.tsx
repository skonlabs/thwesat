    ...
    <div className="min-h-screen bg-background">
      <div className="px-6 pt-6">
        <div className="mb-4 flex items-center gap-3">
          ...
          <div>
            <h1 className="text-xl font-bold text-foreground">သိမ်းထားသော အလုပ်များ</h1>
            <p className="text-xs text-muted-foreground">Saved Jobs · {savedJobs.length} jobs</p>
          </div>
        </div>
      </div>
        ...
        {savedJobs.map((job, i) => (
          ...
          >
            ...
            <div className="mt-3 flex items-center justify-between border-t border-border pt-3">
              <span className="text-[10px] text-muted-foreground">Saved {job.savedDate}</span>
