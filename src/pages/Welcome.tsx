    ...
    <div className="relative flex min-h-screen flex-col items-center justify-between overflow-hidden bg-background">
      ...
      <div className="relative z-10 flex flex-1 flex-col items-center justify-center px-8 text-center">
        ...
        <motion.h1
          ...
          className="text-gradient-gold mb-2 text-4xl font-bold"
        >
          ThweSone
        </motion.h1>
        ...
        <motion.p
          ...
          className="mb-8 max-w-xs text-sm text-muted-foreground"
        >
        ...
        <motion.p
          ...
          className="mb-12 text-xs text-muted-foreground/70"
        >
      ...
      >
        ...
        >
          အကောင့်ရှိပြီးသား? ဝင်ရောက်ရန် · Sign In
        </Button>
      </motion.div>
    </div>
  );
