...
const Login = () => {
  ...
  return (
    <div className="min-h-screen bg-background px-6 pt-6">
      <button onClick={() => navigate("/")} className="mb-4 flex items-center gap-1 text-muted-foreground">
      ...
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="flex flex-col">
        ...
        <h1 className="mb-1 text-2xl font-bold text-foreground">ပြန်လည်ဝင်ရောက်ရန်</h1>
        <p className="mb-8 text-sm text-muted-foreground">Welcome back · ကြိုဆိုပါသည်</p>
