  ...
  return (
    <div className="min-h-screen bg-background px-6 pt-6">
      <button onClick={() => navigate(-1)} className="mb-4 flex items-center gap-1 text-muted-foreground">
        ...
        <span className="text-sm">နောက်သို့</span>
      </button>
      ...
      >
        ...
        <p className="mb-8 text-sm text-muted-foreground">
          Create your account · အခမဲ့ဖြစ်ပါသည်
        </p>
        ...
        <div className="space-y-4">
          <div>
            <Label className="mb-1.5 text-sm text-foreground">အမည် · Name</Label>
            <div className="relative">
              <User className="absolute left-3.5 top-1/2 h-4 w-4 -translate-y-1/2 text-muted-foreground" />
              <Input
                placeholder="သင့်အမည်ကို ထည့်ပါ"
                className="h-12 rounded-xl border-border bg-card pl-10 text-sm"
              />
            </div>
          </div>

          <div>
            <Label className="mb-1.5 text-sm text-foreground">အီးမေးလ် · Email</Label>
            <div className="relative">
          ...
          <div>
            <Label className="mb-1.5 text-sm text-foreground">စကားဝှက် · Password</Label>
            <div className="relative">
              <Lock className="absolute left-3.5 top-1/2 h-4 w-4 -translate-y-1/2 text-muted-foreground" />
              <Input
                type={showPassword ? "text" : "password"}
                placeholder="••••••••"
                className="h-12 rounded-xl border-border bg-card pl-10 pr-10 text-sm"
              />
              <button
