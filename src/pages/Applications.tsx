...
const Applications = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <AnimatePresence>
        {selectedApp !== null && (
          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} className="fixed inset-0 z-[60] flex items-end justify-center bg-foreground/40" onClick={() => setSelectedApp(null)}>
