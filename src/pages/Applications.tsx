...
const Applications = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <AnimatePresence>
        {selectedApp !== null && (
          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} className="fixed inset-0 z-50 flex items-end justify-center bg-foreground/40" onClick={() => setSelectedApp(null)}>
            <motion.div initial={{ y: 300 }} animate={{ y: 0 }} exit={{ y: 300 }} className="w-full max-w-lg rounded-t-3xl bg-card p-6 pb-20" onClick={e => e.stopPropagation()}>
