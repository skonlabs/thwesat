...
import { EmailAPIError, parseEmailWebhookPayload, sendLovableEmail } from 'npm:@lovable.dev/email-js'
...
const FROM_DOMAIN = "notify.thwesat.com" // Domain shown in From address (may be root or sender subdomain)
