// ThweSat Use Cases v7.0 — comprehensive coverage (250+ cases)
...
const children = [];
children.push(new Paragraph({ heading:HeadingLevel.TITLE, alignment:AlignmentType.CENTER, children:[T('ThweSat Use Cases v7.0', {bold:true, size:44})], spacing:{after:120} }));
...
Packer.toBuffer(doc).then(buf=>{
  fs.writeFileSync('/mnt/documents/ThweSat_Use_Cases_v7.0.docx', buf);
  console.log('Wrote v7.0 with', CASES.length, 'use cases');
});
